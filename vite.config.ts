...
const MODULE_ID = 'whisper-box';
const PACKAGE_ID = `modules/${MODULE_ID}`;
const MODULE_FULLNAME = 'whisper-box';
const ENTRY_TYPESCRIPT = 'whisper-box.ts';
...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      [`^(/${PACKAGE_ID}/(images|fonts|assets|lang|languages|packs|templates|${MODULE_FULLNAME}.css|style.css))`]:
